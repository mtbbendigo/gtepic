...
menuHTML += <?php echo $jh->encode(t('Page currently in edit mode on %s', date(DATE_APP_GENERIC_MDYT)))?>;
...
menuHTML += '</div>';
menuHTML += '<span class="label notice">' + <?php echo $jh->encode(t('Version %s', $c->getVersionID()))?> + '</span>';
menuHTML += <?php echo $jh->encode(t('Page last edited on %s', $c->getCollectionDateLastModified(DATE_APP_GENERIC_MDYT)))?>;
