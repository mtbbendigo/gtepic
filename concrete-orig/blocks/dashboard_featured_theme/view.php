...
<?php if (is_object($remoteItem)) { ?>
	...
	<a href="javascript:void(0)" onclick="ccm_getMarketplaceItemDetails(<?php echo $remoteItem->getMarketplaceItemID()?>)" href="<?php echo $remoteItem->getRemoteURL()?>" class="btn"><?php echo t('Learn More')?></a>
<?php } else { ?>
