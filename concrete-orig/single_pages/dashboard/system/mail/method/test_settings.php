...
?><form method="post" action="<?php echo $this->url('/dashboard/system/mail/method/test_settings', 'test')?>" class="form-horizontal" id="mail-settings-test-form">
	...
	<div class="ccm-pane-footer">
		<a href="<?php echo $this->url('/dashboard/system/mail/method')?>" class="btn"><?php echo t('Change Settings')?></a>
		<?php
		if (ENABLE_EMAILS) {
